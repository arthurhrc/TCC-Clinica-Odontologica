(function () {
    ...
    <header>
        <div class="menu-container">
            <div class="menu-box">
                <a href="inicio.html" class="menu-brand">🦷 OdontoClinic</a>
                <nav>
                    <ul class="menu-horizontal">
                        <li class="drop-hover">
                            <a href="#">Cadastros <i class="bi bi-caret-down-fill" style="font-size:10px"></i></a>
                            <div class="drop">
                        ...
                        <li class="drop-hover">
                            <a href="#">Gerencial <i class="bi bi-caret-down-fill" style="font-size:10px"></i></a>
                            <div class="drop">
                        ...
                        <li class="drop-hover-consulta">
                            <a href="#">Consultas <i class="bi bi-caret-down-fill" style="font-size:10px"></i></a>
                            <div class="drop">
